...
int main()
{
    ...
    */
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        if (colorPhase == 0) {
            arrow.at(3) -= colorSpeed;
            arrow.at(4) += colorSpeed;
            arrow.at(10) -= colorSpeed;
            arrow.at(11) += colorSpeed;
            arrow.at(17) -= colorSpeed;
            arrow.at(15) += colorSpeed;
            if (arrow.at(4) >= 1.0f) {
                colorPhase = 1;
            }
        }
            ...
            arrow.at(4) -= colorSpeed;
            arrow.at(5) += colorSpeed;
            arrow.at(11) -= colorSpeed;
            arrow.at(9) += colorSpeed;
            arrow.at(15) -= colorSpeed;
            arrow.at(16) += colorSpeed;
            if (arrow.at(5) >= 1.0f) {
                colorPhase = 2;
            }
        }
